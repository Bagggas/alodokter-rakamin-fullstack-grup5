    ...
    <div class="row g-5">
      ...
      <div class="col-md-2">
        ...
        <ul>
          ...
          <li class="page-list">
            <router-link class="nav-link px-2" to="/"><small>Dokter</small></router-link>
          </li>
          <li class="page-list">
            <router-link class="nav-link px-2" to="/tentang-kami"><small>Tentang</small></router-link>
          </li>
          <li class="page-list">
            <router-link class="nav-link px-2" to="/konsultasi"><small>Konsultasi</small></router-link>
          </li>
        </ul>
      </div>
      <div class="col-md-2">
